...
* "Login" page contains a mock login system. By clicking an avatar user can mock logging in
...
* Navigation can be found from the top left of each page after the user has been logged in.
